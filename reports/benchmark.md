...
- Average retrieval latency: **1082.0 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.0 | 133 | 0.0% |  |
| E06 | semantic | PASS | 389.0 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1472.4 | 808 | 0.0% |  |
| E10 | short_term | PASS | 0.3 | 195 | 0.0% |  |
| E02 | long_term | PASS | 3307.7 | 1354 | 0.0% |  |
| E03 | long_term | PASS | 1371.1 | 1358 | 0.0% |  |
| E04 | episodic | PASS | 336.7 | 248 | 0.0% |  |
| E05 | episodic | PASS | 266.0 | 267 | 0.0% |  |
| E07 | mixed | PASS | 2282.8 | 485 | 14.2% |  |
| E11 | semantic | PASS | 295.4 | 146 | 74.2% |  |
| E08 | long_term | PASS | 2180.2 | 1349 | 0.0% |  |
...
`<USER_SUMMARY> The user's company project BLUEBIRD-42 requires the backend to use TypeScript with NestJS, and Python is not to be used for the backend of this project. The user's personal project is ORCHID-27, for which Python is still used for demos.  The user prefers Python over Java and likes short code examples. Their personal project is ORCHID-27. They are currently learning async/await in Python and sometimes confuse coroutines with Tasks. If this topic arises again, they want it explained using a timeline.  When explaining code, use short examples. When discussing async/await, coroutines, and Tasks, use a timeline for explanations. </USER_SUMMARY>  <EPISODES> Episodes are source messa`
